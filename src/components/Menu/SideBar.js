                     ...
                     <li className="nav-item">
                         <Link to="/admin/" className="nav-link d-flex align-items-center">
                             <span className="sidebar-icon">
                                 <img src="/admin/img/favicon/favicon-32x32.png" height="32" width="32" alt="Logo" />
                             </span>
                             <span className="mt-1 ms-1 sidebar-text">Sarnento</span>
                         </Link>
                     </li>
                     <SideBarItem to="/admin/dashboard" text="Dashboard">
                         <svg className="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                             <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                             <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                         </svg>
                     </SideBarItem>
                     <SideBarItem to="/admin/settings" text="Settings">
                         <svg className="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                             <path fillRule="evenodd"
